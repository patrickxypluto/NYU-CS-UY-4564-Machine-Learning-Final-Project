...
This is our final Project for CS-UY 4564 Machine Learning at NYU. We aim to build a robust binary classifier that distinguishes Asian from Non-Asian faces based solely on pixel information. We apply three families of models — logistic regression, fully connected neural networks, and
...
Mendeley Data, V1, doi: 10.17632/6wcczyfdrb.1
https://data.mendeley.com/datasets/6wcczyfdrb/1
